...
- *just_giving_data_pull.R* pulls data on charities which can be specified using command line arguments. Running `rscript justgiving_data_pull.R --help` gives further detail on all available arguments. (See `optparse` tool) 
